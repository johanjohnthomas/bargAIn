...
class _ProductPage3State extends State<ProductPage3> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        debugShowCheckedModeBanner: false, home: ProductPages3());
  }
}

class ProductPages3 extends StatefulWidget {
  @override
  State<ProductPages3> createState() => _ProductPages3State();
}

class _ProductPages3State extends State<ProductPages3> {
  OverlayEntry? entry;
                                ...
                                Column(
                                  children: [
                                    ...
                                    Image(
                                      width: 280,
                                      image: AssetImage(
                                          "images/CommonOpinions-3.png"),
                                    ),
                                    SizedBox(height: 20),
                                    Image(
                                      width: 280,
                                      image: AssetImage("images/Reviews-3.png"),
                                    ),
                                    SizedBox(height: 20),
                                    TextButton(
                                      onPressed: () {},
